...
local TweenInfoBring = TweenInfo.new(
    1.9, -- velocidade do tween (chậm hơn)
...
local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/id202azh/nyann./refs/heads/main/raw_fixed_on_off_white.txt"))()
...
Discord:AddParagraph({
    "Thông báo",
    "Script đã được update. Thời gian update 17-8-2026, nếu có gặp lỗi hãy nhắn qua các trang mạng xã hội của tôi"
})
...
Discord:AddDiscordInvite({
    Name = "Instagram",
    Description = "Theo dõi để nhận đc acc free (nếu t có acc)!",
    Logo = "rbxassetid://94678517792779",
