...
local Window = redzlib:MakeWindow({
  Title = "Redz Hub remake : Blox Fruits",
  SubTitle = "remake by real_@nyann",
  SaveFolder = "Redz Mod.lua"
})

-- ==================== FORCE PIXEL FONT TOÀN BỘ MENU ====================
local PIXEL_FONT = Enum.Font.Arcade -- Press Start 2P (pixel cổ điển)
...
task.spawn(function()
    task.wait(0.6) -- đợi UI load xong
    ...
    local function scan(parent)
        ...
        parent.DescendantAdded:Connect(ApplyPixelFont)
    end

    -- Quét CoreGui (nơi redzlib thường đặt ScreenGui)
    ...
    -- Tiếp tục quét thêm vài lần để bắt object tạo muộn
    for i = 1, 5 do
        task.wait(1)
        for _, gui in pairs(game:GetService("CoreGui"):GetChildren()) do
            if gui:IsA("ScreenGui") then
...
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://80424431930361", BackgroundTransparency = 0 },
