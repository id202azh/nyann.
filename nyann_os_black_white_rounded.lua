...
local function CreateStarEffect(ParentFrame)
    ...
    local Stars = {}
    for i = 1, 0 do -- Số lượng ngôi sao
...
local function ButtonFrame(Instance, Title, Description, HolderSize)
	...
	local Frame = Make("Button", Instance, {
		...
		AutomaticSize = "Y",
		Name = "Option"
	})Make("Corner", Frame, UDim.new(0, 10))Make("Stroke", Frame)
...
function redzlib:MakeWindow(Configs)
    ...
    local Stroke = Instance.new("UIStroke") -- Tạo viền trắng nhẹ
    Stroke.Thickness = 2
    Stroke.Color = Color3.fromRGB(255, 255, 255) -- Màu đỏ rực
...
-- ... (Code phía dưới giữ nguyên)
	...
	function Window:MakeTab(paste, Configs)
		...
		local function Tabs()
			...
			CreateTween({LabelTitle, "TextColor3", Color3.fromRGB(0, 0, 0), 0.2})
			CreateTween({TabSelect, "BackgroundColor3", Color3.fromRGB(255, 255, 255), 0.2})
		...
		function Tab:Disable()
			...
			CreateTween({TabSelect, "BackgroundColor3", Color3.fromRGB(0, 0, 0), 0.2})
